...
static mlir::GenRegistration
    genOpCPPImpl("gen-cpp-impl", "Generate Op Lib C++ EDSL impl",
                 [](const RecordKeeper &records, raw_ostream &os) {
                   return cpp::genImpl(records, os);
                 });

static mlir::GenRegistration
    genOpCPPWrappers("gen-cpp-wrappers", "Generate Op Lib C++ EDSL wrappers",
                     [](const RecordKeeper &records, raw_ostream &os) {
                       return cpp::genWrappers(records, os);
                     });

static mlir::GenRegistration
    genOpPYWrappers("gen-py-wrappers", "Generate Op Lib Python EDSL wrappers",
                    [](const RecordKeeper &records, raw_ostream &os) {
