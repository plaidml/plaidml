...
typedef boost::multiprecision::number<IntegerBackend,
                                      boost::multiprecision::et_off>
    Integer;
typedef boost::multiprecision::number<RationalBackend,
                                      boost::multiprecision::et_off>
    Rational;
...
// Modulo like reduction, that is, find r, 0 <= v < m, such that r = k*m + v for
// some integer k
Rational Reduce(const Rational &v,
                const Rational &m); // NOLINT(runtime/references)
// Compute the extended common denominator over rational.  That is, find a
// return value r, such that a / r is an integer, and b / r is an integer, and r
// = x*a + y*b
...
// Returns the integer quotient of dividing a by b, w/ rational remainder 0 <= r
// < b
