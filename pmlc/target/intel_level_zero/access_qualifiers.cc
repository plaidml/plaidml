...
class IntelLevelZeroSetAccessQualifiers
    : public IntelLevelZeroSetAccessQualifiersBase<
          IntelLevelZeroSetAccessQualifiers> {
public:
...
std::unique_ptr<mlir::Pass> createSetAccessQualifiersPass() {
  return std::make_unique<IntelLevelZeroSetAccessQualifiers>();
}
