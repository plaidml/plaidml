...
//  PLAIDML_VERBOSE=4 bazel-bin/pmlc/opt -convert-linalg-to-loops -pxa-reorder-layouts="allow-reorder=true maker-user-layouts-explicit=true" -canonicalize -x86-affine-stencil-xsmm  pmlc/target/x86/tests/stub_conv_NCHW_3X3_to_NHWC16c.mlir
