// RUN: pmlc-opt --pass-pipeline='x86-affine-stencil-xsmm{threads=4 batched=true}' %s | FileCheck %s
// RUN: pmlc-opt --pass-pipeline='x86-affine-stencil-xsmm{threads=4 batched=false}' %s | FileCheck %s
