...
func.func @dot(%A: memref<4x8xf32>, %B: memref<8x6xf32>, %C: memref<4x6xf32>) -> memref<4x6xf32> {
...
//       CHECK:     affine.for
//       CHECK:       xsmm.gemm.invoke.f32
func.func @res2a_branch2a(%I: memref<1x56x56x64xf32>, %K: memref<1x1x64x64xf32>, %O: memref<1x56x56x64xf32>) -> memref<1x56x56x64xf32> {
...
// CHECK-LABEL: func.func @conv_pad
...
func.func @conv_pad(%I: memref<1x16x16x16xf32>, %K: memref<3x3x16x16xf32>, %O: memref<1x14x14x16xf32>) -> memref<1x14x14x16xf32> {
