...
// CHECK: #[[map7:.*]] = affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>
// CHECK: #[[map8:.*]] = affine_map<(d0, d1, d2, d3) -> (d3)>
...
//  CHECK-SAME:     outs(%[[X4]] : tensor<4x4x1x1x16x16xf32>)
//       CHECK:   ^bb0(%[[arg3:[a-z0-9]+]]: f32, %[[arg4:[a-z0-9]+]]: f32):  // no predecessors
//       CHECK:     linalg.yield %[[arg3]] : f32
...
//  CHECK-SAME:     iterator_types = ["parallel", "parallel", "parallel", "parallel", "parallel"]
//  CHECK-SAME:     ins(%[[X6]] : tensor<1x4x56x56x16xf32>)
//  CHECK-SAME:     outs(%[[X0]] : tensor<1x56x56x64xf32>)
//       CHECK:   ^bb0(%[[arg3:[a-z0-9]+]]: f32, %[[arg4:[a-z0-9]+]]: f32):  // no predecessors
//       CHECK:     linalg.yield %[[arg3]] : f32
//       CHECK:   } -> tensor<1x56x56x64xf32>
//       CHECK:   %[[X8:.*]] = linalg.generic
//  CHECK-SAME:     indexing_maps = [#[[map7]], #[[map8]], #[[map7]]]
//  CHECK-SAME:     iterator_types = ["parallel", "parallel", "parallel", "parallel"]
//  CHECK-SAME:     ins(%[[X7]], %[[arg2]] : tensor<1x56x56x64xf32>, tensor<64xf32>)
//  CHECK-SAME:     outs(%[[X0]] : tensor<1x56x56x64xf32>)
//       CHECK:     addf
//       CHECK:     linalg.yield
//       CHECK:   } -> tensor<1x56x56x64xf32>
//       CHECK:   %[[X9:.*]] = linalg.generic
//  CHECK-SAME:     indexing_maps = [#[[map7]], #[[map7]]]
//  CHECK-SAME:     iterator_types = ["parallel", "parallel", "parallel", "parallel"]
//  CHECK-SAME:     ins(%[[X8]] : tensor<1x56x56x64xf32>)
//  CHECK-SAME:     outs(%[[X0]] : tensor<1x56x56x64xf32>)
//       CHECK:     stdx.relu
//       CHECK:     linalg.yield
//       CHECK:   } -> tensor<1x56x56x64xf32>
