...
namespace pmlc::target::x86 {
  ...
  namespace {
    ...
    struct PxaBRGemmOpConversion : public OpConversionPattern<pxa::PxaBRGemmOp> {
      ...
      LogicalResult
        ...
        rewriter.create<xsmm::BRGemmInvokeOp>(op.getLoc(), ArrayRef<Type>(), dispatch,
          transformed.c(), transformed.a(),
          transformed.b(), op.lBr(), indices);
    ...
    struct XSMMBRGemmDispatchLowering
      ...
      LogicalResult
        ...
        // stride_a
        callOperands.push_back(
          rewriter.create<LLVM::ConstantOp>(op->getLoc(), int32Type, dispatchOp.StrideA()));
          */
    ...
    struct XSMMBRGemmInvokeLowering
      ...
      LogicalResult
        ...
        auto lBrValue = rewriter.create<LLVM::ConstantOp>(op->getLoc(), int64Type, lBr);
  ...
  void populatePXABRGemmToXSMMConversionPatterns(OwningRewritePatternList &patterns,
    MLIRContext *ctx) {
  ...
  void populateXSMMToLLVMConversionPatterns(LLVMTypeConverter &converter,
    ...
    patterns.insert<XSMMBRGemmDispatchLowering, XSMMBRGemmInvokeLowering>(converter);
  }
} // namespace pmlc::target::x86
