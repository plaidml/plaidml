...
module @get_value {
  ...
  func @main(%arg0: memref<1x1x64x64xf32>, %arg1: memref<1x56x56x64xf32>, %arg2: memref<1x56x56x64xf32>) {
    ...
    %c2 = constant 2 : index
    %c1 = constant 1 : index
    // CHECK: omp.parallel num_threads(%c64 : index) default(shared)
    ...
    // CHECK: omp.parallel num_threads(%c56 : index) default(shared)
    scf.parallel (%arg3) = (%c0) to (%c56) step (%c1) {
      scf.for %arg4 = %c0 to %c2 step %c1 {
        %1 = muli %arg4, %c28 : index
        xsmm.gemm.invoke.f32 %0, %arg2[%c0, %1, %arg3, %c0] = %arg1[%c0, %1, %arg3, %c0], %arg0[%c0, %c0, %c0, %c0] : (memref<1x56x56x64xf32>, memref<1x1x64x64xf32>) -> memref<1x56x56x64xf32>
      }
      // CHECK: omp.terminator
      scf.yield
    }
