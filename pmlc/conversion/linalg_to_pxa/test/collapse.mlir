...
// CHECK: %[[out0:.*]] = memref.alloc() : memref<12x5xf32>
// CHECK: %[[out1:.*]] = affine.parallel (%[[arg2:.*]], %[[arg3:.*]], %[[arg4:.*]]) = (0, 0, 0) to (3, 4, 5) reduce ("assign") -> (memref<12x5xf32>)
// CHECK:   %[[t0:.*]] = pxa.load %[[arg0]][%[[arg2]], %[[arg3]], %[[arg4]]] : memref<3x4x5xf32>
// CHECK:   %[[t1:.*]] = pxa.reduce assign %[[t0]], %[[out0]][%[[arg2]] * 4 + %[[arg3]], %[[arg4]]] : memref<12x5xf32>
// CHECK:   affine.yield %[[t1]] : memref<12x5xf32>
// CHECK: return %[[out1]] : memref<12x5xf32>
