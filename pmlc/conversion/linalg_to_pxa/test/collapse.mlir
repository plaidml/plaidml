...
func.func @test_collapse_reshape(%arg0: tensor<3x4x5xf32>) -> tensor<12x5xf32> {
  %0 = tensor.collapse_shape %arg0 [[0, 1], [2]] : tensor<3x4x5xf32> into tensor<12x5xf32>
  return %0 : tensor<12x5xf32>
}

// CHECK-LABEL: func.func @test_collapse_reshape
...
func.func @zero_dim(%arg0: tensor<1x1x1xi32>) -> tensor<i32> {
  %0 = tensor.collapse_shape %arg0 [] : tensor<1x1x1xi32> into tensor<i32>
  return %0 : tensor<i32>
}

// CHECK-LABEL: func.func @zero_dim
