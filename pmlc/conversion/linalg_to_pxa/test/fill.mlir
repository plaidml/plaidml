...
// CHECK: %[[out:.*]] = affine.parallel (%[[arg2:.*]], %[[arg3:.*]]) = (0, 0) to (16, 16) reduce ("assign") -> (memref<16x16xf32>)
// CHECK:   %[[t0:.*]] = pxa.reduce assign %[[cst]], %[[arg0]][%[[arg2]], %[[arg3]]] : memref<16x16xf32>
// CHECK:   affine.yield %[[t0]] : memref<16x16xf32>
// CHECK: return %[[out]] : memref<16x16xf32>
