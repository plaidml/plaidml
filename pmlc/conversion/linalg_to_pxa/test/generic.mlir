...
// CHECK: %[[out:.*]] = affine.parallel (%[[arg3:.*]], %[[arg4:.*]], %[[arg5:.*]], %[[arg6:.*]], %[[arg7:.*]], %[[arg8:.*]], %[[arg9:.*]]) = (0, 0, 0, 0, 0, 0, 0) to (1, 112, 112, 32, 3, 3, 3) reduce ("addf") -> (memref<1x112x112x32xf32>)
...
// CHECK: return %[[out]] : memref<1x112x112x32xf32>
