...
func.func @index0() -> tensor<3x4x5xsi32> {
  %0 = tile.index 0 : tensor<3x4x5xsi32>
  return %0 : tensor<3x4x5xsi32>
}

// CHECK-LABEL: func.func @index0
...
func.func @index1() -> tensor<3x4x5xsi32> {
  %0 = tile.index 1 : tensor<3x4x5xsi32>
  return %0 : tensor<3x4x5xsi32>
}

// CHECK-LABEL: func.func @index1
// CHECK: linalg.init_tensor 
// CHECK: linalg.generic 
...
func.func @index2() -> tensor<3x4x5xsi32> {
  %0 = tile.index 2 : tensor<3x4x5xsi32>
  return %0 : tensor<3x4x5xsi32>
}

// CHECK-LABEL: func.func @index2
// CHECK: linalg.init_tensor 
// CHECK: linalg.generic 
