...
module @get_value  {
  func @main(%arg0: tensor<1x1x3x1xf32> {stdx.const}, %arg1: tensor<1x4x1x1xf32> {stdx.const}) -> tensor<1x1x9x1xf32> {
    ...
    %conv = tile.contract add, mul, %cst, %arg0, %arg1 {cons = #set, lowerBounds = #map0, sink = #map1, srcs = [#map2, #map3], upperBounds = #map4} : tensor<f32>, tensor<1x1x3x1xf32>, tensor<1x4x1x1xf32> -> tensor<1x1x9x1xf32>
