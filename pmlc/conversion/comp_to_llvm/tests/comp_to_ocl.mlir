...
module {
  ...
  func @create_destroy(%dev: !comp.device<ocl>) {
    %env = comp.create_execenv %dev : (!comp.device<ocl>) -> !comp.execenv<ocl:0,(11)>
...
module {
  ...
  //       CHECK:   llvm.call @oclDestroy(%[[ENV]])
  func @no_gpu_func(%dev: !comp.device<ocl>) {
    %env = comp.create_execenv %dev : (!comp.device<ocl>) -> !comp.execenv<ocl:0,(11)>
...
module {
  ...
  //       CHECK:   llvm.call @oclDestroy(%[[ENV]])
  func @alloc_dealloc(%dev: !comp.device<ocl>) {
    %env = comp.create_execenv %dev : (!comp.device<ocl>) -> !comp.execenv<ocl:0,(11)>
...
module attributes {gpu.container_module} {
  ...
  //       CHECK:   llvm.call @oclDealloc(%[[ENV]], %[[MEM]])
  //       CHECK:   llvm.call @oclDestroy(%[[ENV]])
  func @one_gpu_func(%dev: !comp.device<ocl>, %arg0: memref<8x32xf32>) {
    %c8 = constant 8 : index
...
module attributes {gpu.container_module} {
  ...
  //       CHECK:   llvm.call @oclDealloc(%[[ENV]], %[[MEM]])
  //       CHECK:   llvm.call @oclDestroy(%[[ENV]])
  func @one_gpu_func(%dev: !comp.device<ocl>, %arg0: memref<8x32xf16>) {
    %c8 = constant 8 : index
    %c32 = constant 32 : index
    %c1 = constant 1 : index
    %env = comp.create_execenv %dev : (!comp.device<ocl>) -> !comp.execenv<ocl:0,(11)>
