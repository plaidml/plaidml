...
// CHECK-LABEL: func.func @vectorize_gemm
func.func @vectorize_gemm(%arg0: memref<64x64xf32>, %arg1: memref<64x64xf32>) -> (memref<64x64xf32>, memref<64xf32>) {
...
// CHECK-LABEL: func.func @vector_set
func.func @vector_set(%val: f32) -> (memref<64xf32>) {
...
// CHECK-LABEL: func.func @vectorize_reduce_stride_0
func.func @vectorize_reduce_stride_0(%a: memref<1x4x128x24xf32>, %b: memref<1x4x128x24xf32>, %c: memref<1x1x1x1xf32>) -> memref<1x1x1x1xf32> {
