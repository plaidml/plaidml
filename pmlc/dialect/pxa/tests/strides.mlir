...
func.func @simple(%arg0: memref<100x100xf32>, %arg1: memref<100x100xf32>, %arg2: memref<100x100xf32>) {
...
func.func @symbolic_fail(%arg0: memref<100x?xf32>) {
...
func.func @for_diagonal(%arg0: memref<100x100xf32>) {
...
func.func @for_step(%arg0: memref<100x100xf32>) {
...
func.func @parallel_step(%arg0: memref<100x100xf32>) {
...
func.func @parallel_tile(%arg0: memref<100x100xf32>) {
...
func.func @affine_apply(%arg0: memref<100x100xf32>) {
  affine.for %i = 0 to 10 {
...
func.func @affine_apply_add(%arg0: memref<100x100xf32>) {
  affine.for %i = 0 to 10 {
...
func.func @dot_tiled(%A: memref<8x8xf32>, %B: memref<8x8xf32>, %C: memref<8x8xf32>) {
...
func.func @conv2_tiled(%I: memref<1x6x5x7xf32>, %K: memref<1x1x7x11xf32>, %O: memref<1x6x5x11xf32>) {
