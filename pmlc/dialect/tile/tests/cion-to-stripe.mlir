...
// CHECK-DAG:        %[[OUT:.*]] = stripe.refine %arg2(%x0, %x1) : !fp32_2
// CHECK-DAG:        %[[IN1:.*]] = stripe.refine %arg0(%x0, %x2) : !fp32_2 {name = "_X0", stripe_attrs = {contraction}}
// CHECK-DAG:        %[[IN2:.*]] = stripe.refine %arg1(%x2, %x1) : !fp32_2 {name = "_X1", stripe_attrs = {contraction}}
