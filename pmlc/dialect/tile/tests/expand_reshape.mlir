...
// CHECK-SAME: (%[[arg0:.*]]: tensor<4x4x4x4xf16>) -> tensor<1x4x4x16xf16>
  ...
  // CHECK: %[[ret:.*]] = tile.contract assign, none, {{.*}}, %[[arg0]] {sink = #map0, srcs = [#map1], upperBounds = #map2} : tensor<f16>, tensor<4x4x4x4xf16> -> tensor<1x4x4x16xf16>
