...
module {
  func @higher_precision_constants(%arg0: tensor<3x3x!eltwise.f32>) -> tensor<3x3x!eltwise.f32> {
    ...
    %1 = "eltwise.add"(%0, %cst) : (tensor<3x3x!eltwise.f32>, !f32) -> tensor<3x3x!eltwise.f32>
