// RUN: pmlc-opt -tile-legalize-to-stripe %s | FileCheck %s --dump-input-on-failure
...
// CHECK-NEXT:     ^bb0(%i0: !aff, %i1: !aff):	// no predecessors
...
// CHECK-NEXT:     ^bb0(%x0: !aff, %x1: !aff, %x2: !aff):	// no predecessors
...
// CHECK-NEXT:       stripe.aggregate %0, %5 : !fp32_2 {agg = 1 : i64}
// CHECK-NEXT:       stripe.terminate
// CHECK-NEXT:     }
// CHECK-NEXT:     stripe.terminate
// CHECK-NEXT:   }
...
// CHECK-NEXT:       stripe.aggregate %1, %6 : !fp32_2 {agg = 1 : i64}
// CHECK-NEXT:       stripe.terminate
// CHECK-NEXT:     }
