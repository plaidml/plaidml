...
block []:1 ( // foo
  ...
  block<OuterExecutor[0]/InnerExecutor[1]> []:1 ( // main
      ...
      none new@0x00000000 O[0, 0, 0, 0]:add fp32:I(16, 112, 112, 128):(1605632, 14336, 128, 1):100352 KiB
    ...
    block [ci:64, co:128, k0:3, k1:3, n:16, x0:112, x1:112]:14797504512 ( // kernel_0(I,K)
        ...
        out O[n, x0, x1, co]:add fp32:I(1, 1, 1, 1):(1605632, 14336, 128, 1):4 B, E(16, 112, 112, 128):100352 KiB
    ) {
      0: $s0 = load(I)
      1: $s1 = load(K)
      2: $s2 = mul($s0, $s1)
