...
func @invalid_runtime(%dev: !comp.device<ocl>) {
  // expected-error@+2 {{unrecognized runtime string name}}
  // expected-note@+1 {{available runtime names are}}
  %env = comp.create_execenv %dev : (!comp.device<ocl>) -> !comp.execenv<invalid:0,(11)>
  return
}

// -----

func @invalid_schedule(%dev: !comp.device<ocl>) {
  %env = comp.create_execenv %dev : (!comp.device<ocl>) -> !comp.execenv<0:0,(11)>
...
func @invalid_alloc(%dev: !comp.device<ocl>) {
  %env = comp.create_execenv %dev : (!comp.device<ocl>) -> !comp.execenv<0:0,(11)>
...
func @invalid_dealloc(%dev: !comp.device<ocl>) {
  %env = comp.create_execenv %dev : (!comp.device<ocl>) -> !comp.execenv<0:0,(11)>
...
func @invalid_write(%dev: !comp.device<ocl>) {
  %env = comp.create_execenv %dev : (!comp.device<ocl>) -> !comp.execenv<0:0,(11)>
  %host = "op"() : () -> (memref<2x3xf32>)
...
func @invalid_read(%dev: !comp.device<ocl>) {
  %env = comp.create_execenv %dev : (!comp.device<ocl>) -> !comp.execenv<0:0,(11)>
  %host = "op"() : () -> (memref<2x3xf32>)
  %device = "op"() : () -> (memref<2x3xf32, 1>)
...
func @invalid_barrier(%dev: !comp.device<ocl>) {
  %env = comp.create_execenv %dev : (!comp.device<ocl>) -> !comp.execenv<0:0,(11)>
  %ev0 = "op"() : () -> (!comp.event<0>)
  %ev1 = "op"() : () -> (!comp.event<1>)
