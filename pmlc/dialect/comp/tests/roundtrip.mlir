...
func @runtime_number_vk(%arg0 : !comp.device<0>) {
  // CHECK-LABEL: func @runtime_number_vk
  //       CHECK:   comp.create_execenv %arg0 : (!comp.device<vk>) -> !comp.execenv<vk:0,(0)>
  %env = comp.create_execenv %arg0 : (!comp.device<0>) -> !comp.execenv<0:0,(0)>
  return
}

func @runtime_string_vk(%arg0: !comp.device<vk>) {
  // CHECK-LABEL: func @runtime_string_vk
  //       CHECK:   comp.create_execenv %arg0 : (!comp.device<vk>) -> !comp.execenv<vk:0,(1)>
  %env = comp.create_execenv %arg0 : (!comp.device<vk>) -> !comp.execenv<vk:0,(1)>
  return
}

func @runtime_number_ocl(%arg0: !comp.device<ocl>) {
  // CHECK-LABEL: func @runtime_number_ocl
  //       CHECK:   comp.create_execenv %arg0 : (!comp.device<ocl>) -> !comp.execenv<ocl:0,(11)>
  %env = comp.create_execenv %arg0 : (!comp.device<1>) -> !comp.execenv<1:0,(11)>
  return
}

func @runtime_string_ocl(%arg0: !comp.device<ocl>) {
  // CHECK-LABEL: func @runtime_string_ocl
  //       CHECK:   comp.create_execenv %arg0 : (!comp.device<ocl>) -> !comp.execenv<ocl:1,(11)>
  %env = comp.create_execenv %arg0 : (!comp.device<ocl>) -> !comp.execenv<ocl:1,(11)>
  return
}

func @runtime_number_custom(%arg0: !comp.device<1000>) {
  // CHECK-LABEL: @runtime_number_custom
  //       CHECK:   comp.create_execenv %arg0 : (!comp.device<1000>) -> !comp.execenv<1000:0,(2)>
  %env = comp.create_execenv %arg0 : (!comp.device<1000>) -> !comp.execenv<1000:0,(2)>
  return
}

func @runtime_memory_spaces(%arg0: !comp.device<1000>) {
  // CHECK-LABEL: @runtime_memory_spaces
  //       CHECK:   comp.create_execenv %arg0 : (!comp.device<1000>) -> !comp.execenv<1000:0,(2,11,3)>
  %env = comp.create_execenv %arg0 : (!comp.device<1000>) -> !comp.execenv<1000:0,(2,11,3)>
  return
}
