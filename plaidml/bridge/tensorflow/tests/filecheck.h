...
#ifndef PLAIDML_BRIDGE_TENSORFLOW_TESTS_FILECHECK_H_
#define PLAIDML_BRIDGE_TENSORFLOW_TESTS_FILECHECK_H_
...
#endif  // PLAIDML_BRIDGE_TENSORFLOW_TESTS_FILECHECK_H_
