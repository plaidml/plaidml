...
const std::vector<InputShapeParams> inShapeParams = {
    InputShapeParams{2, 9, 3},
};

const std::vector<int32_t> maxOutBoxPerClass = {
    5,
};
...
const std::vector<bool> sortResDesc = {
    true,
    false,
};
const std::vector<ngraph::element::Type> outType = {
    ngraph::element::i32,
    ngraph::element::i64,
};
...
const auto smokeParams = ::testing::Combine(                                  //
    ::testing::Values(InputShapeParams{1, 5, 1}),                             //
    ::testing::Combine(::testing::Values(InferenceEngine::Precision::FP32),   //
                       ::testing::Values(InferenceEngine::Precision::I32),    //
                       ::testing::Values(InferenceEngine::Precision::FP32)),  //
    ::testing::Values(5),                                                     //
