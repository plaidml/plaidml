...
const std::vector<ngraph::element::Type> argDepthType_IC = {
    ngraph::element::i32,
};
const std::vector<int64_t> argDepth_IC = {
    1,
    5,
    1017,
};
const std::vector<ngraph::element::Type> argSetType_IC = {
    ngraph::element::i32,
};
const std::vector<float> argOnValue_IC = {
    0,
    1,
    -29,
};
const std::vector<float> argOffValue_IC = {
    0,
    1,
    -127,
};
const std::vector<int64_t> argAxis_IC = {0};
const std::vector<std::vector<size_t>> inputShapes_IC = {
    {4, 5},
    {3, 7},
};
...
const std::vector<ngraph::element::Type> argDepthType_Ax = {
    ngraph::element::i32,
};
...
const std::vector<int64_t> argAxis_Ax = {
    0, 1, 3, 5, -4, -5,
};
const std::vector<std::vector<size_t>> inputShapes_Ax = {
    {4, 8, 5, 3, 2, 9},
};
...
const std::vector<ngraph::element::Type> argDepthType_T = {
    ngraph::element::i8,
    ngraph::element::u8,
};
...
const std::vector<std::vector<size_t>> inputShapes_T = {
    {2, 2},
};
