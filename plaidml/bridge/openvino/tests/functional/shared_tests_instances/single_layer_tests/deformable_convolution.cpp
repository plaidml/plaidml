...
const std::vector<std::vector<size_t>> deformable_vals = {{1, 54, 28, 28}};
const std::vector<std::vector<size_t>> kernels = {{2, 3, 3, 3}};
const std::vector<std::vector<size_t>> strides = {{1, 1}};
const std::vector<std::vector<ptrdiff_t>> padBegins = {{0, 0}};
const std::vector<std::vector<ptrdiff_t>> padEnds = {{0, 0}};
const std::vector<std::vector<size_t>> dilations = {{1, 1}};
const std::vector<size_t> groups = {2};
const std::vector<size_t> defor_groups = {3};
...
const std::vector<std::vector<size_t>> kernel = {{64, 2, 5, 5}};
...
const auto deformableConv2DParams_DeformableGroups_AutoPadExplicit = ::testing::Combine(  //
    ...
    ::testing::Values(std::vector<ptrdiff_t>({0, 0})),                                    //
    ::testing::ValuesIn(dilations), ::testing::ValuesIn(groups),                          //
    ::testing::ValuesIn(multiple_defor_groups), ::testing::Values(64),                    //
    ::testing::Values(ngraph::op::PadType::EXPLICIT));                                    //
