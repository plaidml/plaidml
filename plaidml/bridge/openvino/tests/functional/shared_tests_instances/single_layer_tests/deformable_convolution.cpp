...
const std::vector<bool> with_bilinear_interpolation_pad = {
    false,
    true,
};
const std::vector<bool> with_modulated_scalar = {
    false,
    true,
};
...
// INSTANTIATE_TEST_SUITE_P(smoke_DeformableConvolution2D_ExplicitPadding, DeformableConvolutionLayerTest,   //
//                         ::testing::Combine(                                                              //
...
//
// INSTANTIATE_TEST_SUITE_P(smoke_DeformableConvolution2D_AutoPadValid, DeformableConvolutionLayerTest,   //
//                         ::testing::Combine(                                                           //
...
// INSTANTIATE_TEST_SUITE_P(smoke_DeformableConvolution2D_SingleTestCase, DeformableConvolutionLayerTest,  //
//                         ::testing::Combine(                                                            //
