...
const std::vector<std::vector<ptrdiff_t>> padding_smoke = {
    {0, 2, 0},
};

const std::vector<std::vector<size_t>> strides_smoke = {
    {1, 2, 1},
};
const std::vector<std::vector<size_t>> dilations_smoke = {
    {1, 2, 1},
};

const auto convSmokeParams_ExplicitPadding = ::testing::Combine(                                 //
    ::testing::ValuesIn(kernel_smoke),                                                           //
...
const auto convSmokeParams_AutoPadValid = ::testing::Combine(                                    //
    ::testing::ValuesIn(kernel_smoke),                                                           //
    ::testing::ValuesIn(strides_smoke),                                                          //
    ::testing::Values(std::vector<ptrdiff_t>({0, 1, 0})),                                        //
    ::testing::Values(std::vector<ptrdiff_t>({0, 1, 0})),                                        //
