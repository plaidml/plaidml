...
std::vector<std::vector<size_t>> shape_index{
    {4, 6, 5},
    {3, 9, 2},
    {1, 4, 2, 1, 1, 3},
};
std::vector<std::vector<size_t>> axes_index{
    {0},
    {1},
    {0, 2},
};

std::vector<std::vector<size_t>> shape_mask{
    {4, 6, 5},
    {3, 9, 2},
    {1, 4, 2},
};
std::vector<std::vector<size_t>> axes_mask{
    {1, 0, 0},
    {0, 1, 0},
    {1, 0, 1},
};
