...
const std::vector<std::vector<size_t>> smoke_inputShapes = {
    {1, 9, 1, 1},
    {1, 9, 2, 2},
    {2, 36, 3, 3},
};

const auto smoke_DepthToSpace = ::testing::Combine(     //
    ::testing::ValuesIn(smoke_inputShapes),             //
    ::testing::ValuesIn(inputPrecisions),               //
    ::testing::ValuesIn(modes),                         //
    ::testing::Values(3),                               //
    ::testing::Values(CommonTestUtils::DEVICE_PLAIDML)  //
...
INSTANTIATE_TEST_CASE_P(smoke, DepthToSpaceLayerTest, smoke_DepthToSpace, DepthToSpaceLayerTest::getTestCaseName);
