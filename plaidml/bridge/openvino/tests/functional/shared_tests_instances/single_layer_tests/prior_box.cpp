...
const std::vector<bool> clip = {false, true};
const std::vector<bool> flip = {false, true};
const std::vector<float> steps = {1.0f, 0.0f, -1.0f};
const std::vector<float> offsets = {0.0f, 0.5f};
const std::vector<std::vector<float>> variances = {{0.1f}, {0.1f, 0.2f, 0.3f, 0.4f}};
...
const auto layerSpecificParamsForSmokeTest = ::testing::Combine(
    ...
    ::testing::Values(true), ::testing::Values(true), ::testing::Values(1.0f), ::testing::Values(0.5f));
