...
using LayerTestsDefinitions::EmbeddingSegmentsSumLayerTest;
...
const std::vector<std::vector<size_t>> segmentIds = {{0, 1, 2, 3, 4}, {0, 0, 2, 2, 4}};
const std::vector<size_t> numSegments = {5, 7};
...
const auto embSegmentsSumArgSet = ::testing::Combine(::testing::ValuesIn(embTableShape),  //
