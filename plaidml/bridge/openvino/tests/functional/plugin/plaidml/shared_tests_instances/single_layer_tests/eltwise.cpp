...
using EltwiseTestNamespace::EltwiseOpType;
using EltwiseTestNamespace::InputLayerType;
using EltwiseTestNamespace::ParameterInputIdx;
...
const auto FlatEltwiseParams = ::testing::Combine(::testing::ValuesIn(operations),                     //
...
const auto NonFlatEltwiseParams = ::testing::Combine(::testing::ValuesIn(operations),                     //
                                                     ::testing::ValuesIn(primary_input_idx),              //
                                                     ::testing::ValuesIn(secondary_input_types),          //
                                                     ::testing::ValuesIn(net_precisions),                 //
...
INSTANTIATE_TEST_CASE_P(Eltwise_flat, EltwiseLayerTest, FlatEltwiseParams, EltwiseLayerTest::getTestCaseName);
INSTANTIATE_TEST_CASE_P(Eltwise_non_flat, EltwiseLayerTest, NonFlatEltwiseParams, EltwiseLayerTest::getTestCaseName);
