...
class TestTileTutorial(unittest.TestCase):
    ...
    def testSumOverAxis(self):
        ...
        op = K._Op('sum_over_axis', I.dtype, I.shape[1], code,
                   OrderedDict([('I', I)]), ['O'])
    ...
    def testMatMul(self):
        ...
        op = K._Op('matmul', A.dtype, (2, 2), code,
                   OrderedDict([('A', A), ('B', B)]), ['C'])
        reference = K.dot(A, B)
        npt.assert_allclose(op.eval(), reference.eval())
    ...
    def testMaxOverAxis(self):
        ...
        op = K._Op('max_over_axis', I.dtype, I.shape[1], code,
                   OrderedDict([('I', I)]), ['O'])
    ...
    def testGlobalMin(self):
        ...
        op = K._Op('global_min', I.dtype, tuple(), code,
                   OrderedDict([('I', I)]), ['O'])
    ...
    def testMeanOverAxis(self):
        ...
        op = K._Op('mean_over_axis', I.dtype, I.shape[1], code,
                   OrderedDict([('I', I)]), ['O'])
    ...
    def testGlobalMeanAwkward(self):
        ...
        op = K._Op('global_mean_awkward', I.dtype, tuple(), code,
                   OrderedDict([('I', I)]), ['O'])
    ...
    def testGlobalMean(self):
        ...
        op = K._Op('global_mean', I.dtype, tuple(), code,
                   OrderedDict([('I', I)]), ['O'])
        reference = K.mean(I, axis=[0, 1])
        npt.assert_allclose(op.eval(), reference.eval())
    ...
    def testCumSum(self):
        ...
        op = K._Op('cumulative_sum', I.dtype, (6,), code,
                   OrderedDict([('I', I)]), ['O'])
        code2 = """function (I[N]) -> (O) {
                       O[i: N] = +(I[k]), i - k < N;
                   }"""
        op2 = K._Op('cumulative_sum2', I.dtype, (6,), code,
                   OrderedDict([('I', I)]), ['O'])
