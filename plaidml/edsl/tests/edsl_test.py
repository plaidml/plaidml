...
module {
  func @higher_precision_constants(%arg0: tensor<3x3xf32>) -> tensor<3x3x!eltwise.f64> {
    %c1 = "eltwise.sconst"() {value = 1 : i64} : () -> !u64
    %cst = "eltwise.sconst"() {value = 2.000000e+00 : f64} : () -> !f64
    %0 = "eltwise.add"(%arg0, %c1) : (tensor<3x3xf32>, !u64) -> tensor<3x3xf32>
    %1 = "eltwise.add"(%0, %cst) : (tensor<3x3xf32>, !f64) -> tensor<3x3x!eltwise.f64>
...
module {
  func @mnist_mlp(%arg0: tensor<10xf32>, %arg1: tensor<512x10xf32>, %arg2: tensor<512xf32>, %arg3: tensor<512x512xf32>, %arg4: tensor<512xf32>, %arg5: tensor<784x512xf32>, %arg6: tensor<1x784xf32>) -> tensor<1x10xf32> {
    ...
    %2 = "eltwise.cmp_lt"(%1, %cst) : (tensor<1x512xf32>, !f32) -> tensor<1x512x!eltwise.u1>
    %3 = "eltwise.select"(%2, %cst, %1) : (tensor<1x512x!eltwise.u1>, !f32, tensor<1x512xf32>) -> tensor<1x512xf32>
    ...
    %6 = "eltwise.cmp_lt"(%5, %cst) : (tensor<1x512xf32>, !f32) -> tensor<1x512x!eltwise.u1>
    %7 = "eltwise.select"(%6, %cst, %5) : (tensor<1x512x!eltwise.u1>, !f32, tensor<1x512xf32>) -> tensor<1x512xf32>
...
module {
  func @mnist_cnn(%arg0: tensor<100xf32>, %arg1: tensor<128x100xf32>, %arg2: tensor<128xf32>, %arg3: tensor<12100x128xf32>, %arg4: tensor<64xf32>, %arg5: tensor<3x3x32x64xf32>, %arg6: tensor<32xf32>, %arg7: tensor<3x3x1x32xf32>, %arg8: tensor<1x224x224x1xf32>) -> tensor<1x100xf32> {
    ...
    %2 = "eltwise.cmp_lt"(%1, %cst) : (tensor<1x222x222x32xf32>, !f32) -> tensor<1x222x222x32x!eltwise.u1>
    %3 = "eltwise.select"(%2, %cst, %1) : (tensor<1x222x222x32x!eltwise.u1>, !f32, tensor<1x222x222x32xf32>) -> tensor<1x222x222x32xf32>
    ...
    %6 = "eltwise.cmp_lt"(%5, %cst) : (tensor<1x220x220x64xf32>, !f32) -> tensor<1x220x220x64x!eltwise.u1>
    %7 = "eltwise.select"(%6, %cst, %5) : (tensor<1x220x220x64x!eltwise.u1>, !f32, tensor<1x220x220x64xf32>) -> tensor<1x220x220x64xf32>
    %8 = tile.contract max, none, %cst, %7 {cons = #set0, sink = #map3, srcs = [#map4]} : !f32, tensor<1x220x220x64xf32> -> tensor<1x110x110x64xf32>
    %9 = "tile.reshape"(%8, %c1, %c12100) : (tensor<1x110x110x64xf32>, !i32, index) -> tensor<1x12100xf32>
    ...
    %12 = "eltwise.cmp_lt"(%11, %cst) : (tensor<1x128xf32>, !f32) -> tensor<1x128x!eltwise.u1>
    %13 = "eltwise.select"(%12, %cst, %11) : (tensor<1x128x!eltwise.u1>, !f32, tensor<1x128xf32>) -> tensor<1x128xf32>
...
module {
  func @arg_max(%arg0: !f32, %arg1: tensor<1x10x10xf32>) -> tensor<1x10x!eltwise.u32> {
    %cst = "eltwise.sconst"() {value = 0.000000e+00 : f64} : () -> !f32
    %0 = tile.contract assign, none, %cst, %arg0 {sink = #map0, srcs = [#map1]} : !f32, !f32 -> tensor<10xf32>
    %1 = "tile.index"(%0) {dim = 0 : i64} : (tensor<10xf32>) -> tensor<10x!eltwise.i32>
    %2 = tile.contract max, none, %cst, %arg1 {sink = #map2, srcs = [#map3]} : !f32, tensor<1x10x10xf32> -> tensor<1x10xf32>
    %3 = tile.contract max, cond, %cst, %arg1, %2, %1 {sink = #map2, srcs = [#map3, #map2, #map4]} : !f32, tensor<1x10x10xf32>, tensor<1x10xf32>, tensor<10x!eltwise.i32> -> tensor<1x10x!eltwise.i32>
