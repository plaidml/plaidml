...
module {
  func @abs(%arg0: tensor<1x224x224x3xf32> {tile.name = "I"}) -> tensor<1x224x224x3xf32> {
    ...
    %1 = "eltwise.cmp_lt"(%arg0, %cst) : (tensor<1x224x224x3xf32>, !f32) -> tensor<1x224x224x3x!eltwise.u1>
    %2 = "eltwise.select"(%1, %0, %arg0) : (tensor<1x224x224x3x!eltwise.u1>, tensor<1x224x224x3xf32>, tensor<1x224x224x3xf32>) -> tensor<1x224x224x3xf32>
...
module {
  func @all(%arg0: tensor<1x224x224x3xf32> {tile.name = "I"}) -> !u8 {
    %cst = "eltwise.sconst"() {value = 0.000000e+00 : f64} : () -> !f32
    %c0 = "eltwise.sconst"() {value = 0 : i64} : () -> !i32
    %c1 = "eltwise.sconst"() {value = 1 : i64} : () -> !i32
    %0 = "eltwise.cmp_eq"(%arg0, %c0) : (tensor<1x224x224x3xf32>, !i32) -> tensor<1x224x224x3x!eltwise.u1>
...
!u8 = type tensor<!eltwise.u8>
module {
  func @any(%arg0: tensor<1x224x224x3xf32> {tile.name = "I"}) -> !u8 {
    %cst = "eltwise.sconst"() {value = 0.000000e+00 : f64} : () -> !f32
    %c0 = "eltwise.sconst"() {value = 0 : i64} : () -> !i32
    %c1 = "eltwise.sconst"() {value = 1 : i64} : () -> !i32
    %0 = "eltwise.cmp_eq"(%arg0, %c0) : (tensor<1x224x224x3xf32>, !i32) -> tensor<1x224x224x3x!eltwise.u1>
...
module {
  func @argmax(%arg0: tensor<1x224x224x3xf32> {tile.name = "I"}) -> !u32 {
    %cst = "eltwise.sconst"() {value = 0.000000e+00 : f64} : () -> !f32
    %c1 = "eltwise.sconst"() {value = 1 : i64} : () -> !i32
    ...
    %3 = tile.contract max, cond, %cst, %arg0, %2, %1 {sink = #map1, srcs = [#map0, #map1, #map0]} : !f32, tensor<1x224x224x3xf32>, !f32, tensor<1x224x224x3x!eltwise.i32> -> !i32
...
module {
  func @binary_crossentropy(%arg0: tensor<7x7x3x64xf32> {tile.name = "O"}, %arg1: tensor<7x7x3x64xf32> {tile.name = "I"}) -> tensor<7x7x3x64xf32> {
    ...
    %0 = "eltwise.cmp_gt"(%arg0, %cst) : (tensor<7x7x3x64xf32>, !f32) -> tensor<7x7x3x64x!eltwise.u1>
    %1 = "eltwise.select"(%0, %arg0, %cst) : (tensor<7x7x3x64x!eltwise.u1>, tensor<7x7x3x64xf32>, !f32) -> tensor<7x7x3x64xf32>
    %2 = "eltwise.cmp_lt"(%1, %cst_0) : (tensor<7x7x3x64xf32>, !f32) -> tensor<7x7x3x64x!eltwise.u1>
    %3 = "eltwise.select"(%2, %1, %cst_0) : (tensor<7x7x3x64x!eltwise.u1>, tensor<7x7x3x64xf32>, !f32) -> tensor<7x7x3x64xf32>
    %4 = "eltwise.sub"(%c1, %3) : (!i32, tensor<7x7x3x64xf32>) -> tensor<7x7x3x64xf32>
    %5 = "eltwise.log"(%4) : (tensor<7x7x3x64xf32>) -> tensor<7x7x3x64xf32>
    %6 = "eltwise.ident"(%arg1) : (tensor<7x7x3x64xf32>) -> tensor<7x7x3x64xf32>
    %7 = "eltwise.sub"(%c1, %6) : (!i32, tensor<7x7x3x64xf32>) -> tensor<7x7x3x64xf32>
...
module {
  func @clip(%arg0: tensor<7x7x3x64xf32> {tile.name = "raw_max"}, %arg1: tensor<7x7x3x64xf32> {tile.name = "raw_min"}, %arg2: tensor<7x7x3x64xf32> {tile.name = "I"}) -> tensor<7x7x3x64xf32> {
    %0 = "eltwise.cmp_gt"(%arg2, %arg1) : (tensor<7x7x3x64xf32>, tensor<7x7x3x64xf32>) -> tensor<7x7x3x64x!eltwise.u1>
    %1 = "eltwise.select"(%0, %arg2, %arg1) : (tensor<7x7x3x64x!eltwise.u1>, tensor<7x7x3x64xf32>, tensor<7x7x3x64xf32>) -> tensor<7x7x3x64xf32>
    %2 = "eltwise.cmp_lt"(%1, %arg0) : (tensor<7x7x3x64xf32>, tensor<7x7x3x64xf32>) -> tensor<7x7x3x64x!eltwise.u1>
    %3 = "eltwise.select"(%2, %1, %arg0) : (tensor<7x7x3x64x!eltwise.u1>, tensor<7x7x3x64xf32>, tensor<7x7x3x64xf32>) -> tensor<7x7x3x64xf32>
...
module {
  func @elu(%arg0: tensor<7x7x3x64xf32> {tile.name = "I"}) -> tensor<7x7x3x64xf32> {
    ...
    %3 = "eltwise.cmp_lt"(%arg0, %c0) : (tensor<7x7x3x64xf32>, !i32) -> tensor<7x7x3x64x!eltwise.u1>
    %4 = "eltwise.select"(%3, %2, %arg0) : (tensor<7x7x3x64x!eltwise.u1>, tensor<7x7x3x64xf32>, tensor<7x7x3x64xf32>) -> tensor<7x7x3x64xf32>
...
module {
  func @hard_sigmoid(%arg0: tensor<10x20xf32> {tile.name = "A"}) -> tensor<10x20xf32> {
    ...
    %2 = "eltwise.cmp_gt"(%arg0, %cst_1) : (tensor<10x20xf32>, !f32) -> tensor<10x20x!eltwise.u1>
    %3 = "eltwise.select"(%2, %cst_2, %1) : (tensor<10x20x!eltwise.u1>, !f32, tensor<10x20xf32>) -> tensor<10x20xf32>
    %4 = "eltwise.cmp_lt"(%arg0, %cst) : (tensor<10x20xf32>, !f32) -> tensor<10x20x!eltwise.u1>
    %5 = "eltwise.select"(%4, %cst_0, %3) : (tensor<10x20x!eltwise.u1>, !f32, tensor<10x20xf32>) -> tensor<10x20xf32>
...
module {
  func @maximum(%arg0: tensor<10x20xf32> {tile.name = "A"}, %arg1: tensor<10x20xf32> {tile.name = "B"}) -> tensor<10x20xf32> {
    %0 = "eltwise.cmp_lt"(%arg0, %arg1) : (tensor<10x20xf32>, tensor<10x20xf32>) -> tensor<10x20x!eltwise.u1>
    %1 = "eltwise.select"(%0, %arg1, %arg0) : (tensor<10x20x!eltwise.u1>, tensor<10x20xf32>, tensor<10x20xf32>) -> tensor<10x20xf32>
...
module {
  func @minimum(%arg0: tensor<10x20xf32> {tile.name = "B"}, %arg1: tensor<10x20xf32> {tile.name = "A"}) -> tensor<10x20xf32> {
    %0 = "eltwise.cmp_lt"(%arg1, %arg0) : (tensor<10x20xf32>, tensor<10x20xf32>) -> tensor<10x20x!eltwise.u1>
    %1 = "eltwise.select"(%0, %arg1, %arg0) : (tensor<10x20x!eltwise.u1>, tensor<10x20xf32>, tensor<10x20xf32>) -> tensor<10x20xf32>
    return %1 : tensor<10x20xf32>
  }
}
...
module {
  func @relu(%arg0: tensor<10x20xf32> {tile.name = "M"}, %arg1: tensor<10x20xf32> {tile.name = "I"}, %arg2: tensor<10x20xf32> {tile.name = "A"}) -> tensor<10x20xf32> {
    ...
    %2 = "eltwise.cmp_lt"(%arg1, %cst) : (tensor<10x20xf32>, !f32) -> tensor<10x20x!eltwise.u1>
    %3 = "eltwise.select"(%2, %1, %arg1) : (tensor<10x20x!eltwise.u1>, tensor<10x20xf32>, tensor<10x20xf32>) -> tensor<10x20xf32>
    %4 = "eltwise.cmp_lt"(%3, %arg0) : (tensor<10x20xf32>, tensor<10x20xf32>) -> tensor<10x20x!eltwise.u1>
    %5 = "eltwise.select"(%4, %3, %arg0) : (tensor<10x20x!eltwise.u1>, tensor<10x20xf32>, tensor<10x20xf32>) -> tensor<10x20xf32>
    return %5 : tensor<10x20xf32>
  }
}
)#"));
...
module {
  func @relu(%arg0: tensor<10x20xf32> {tile.name = "M"}, %arg1: tensor<10x20xf32> {tile.name = "I"}) -> tensor<10x20xf32> {
    %cst = "eltwise.sconst"() {value = 5.000000e-02 : f64} : () -> !f32
    %cst_0 = "eltwise.sconst"() {value = 0.000000e+00 : f64} : () -> !f32
    %0 = "eltwise.cmp_lt"(%arg1, %cst) : (tensor<10x20xf32>, !f32) -> tensor<10x20x!eltwise.u1>
    %1 = "eltwise.select"(%0, %cst_0, %arg1) : (tensor<10x20x!eltwise.u1>, !f32, tensor<10x20xf32>) -> tensor<10x20xf32>
    %2 = "eltwise.cmp_lt"(%1, %arg0) : (tensor<10x20xf32>, tensor<10x20xf32>) -> tensor<10x20x!eltwise.u1>
    %3 = "eltwise.select"(%2, %1, %arg0) : (tensor<10x20x!eltwise.u1>, tensor<10x20xf32>, tensor<10x20xf32>) -> tensor<10x20xf32>
...
module {
  func @relu(%arg0: tensor<10x20xf32> {tile.name = "I"}, %arg1: tensor<10x20xf32> {tile.name = "A"}) -> tensor<10x20xf32> {
    ...
    %2 = "eltwise.cmp_lt"(%arg0, %cst) : (tensor<10x20xf32>, !f32) -> tensor<10x20x!eltwise.u1>
    %3 = "eltwise.select"(%2, %1, %arg0) : (tensor<10x20x!eltwise.u1>, tensor<10x20xf32>, tensor<10x20xf32>) -> tensor<10x20xf32>
    return %3 : tensor<10x20xf32>
  }
}
...
module {
  func @relu(%arg0: tensor<10x20xf32> {tile.name = "I"}) -> tensor<10x20xf32> {
    %cst = "eltwise.sconst"() {value = 5.000000e-02 : f64} : () -> !f32
    %cst_0 = "eltwise.sconst"() {value = 0.000000e+00 : f64} : () -> !f32
    %0 = "eltwise.cmp_lt"(%arg0, %cst) : (tensor<10x20xf32>, !f32) -> tensor<10x20x!eltwise.u1>
    %1 = "eltwise.select"(%0, %cst_0, %arg0) : (tensor<10x20x!eltwise.u1>, !f32, tensor<10x20xf32>) -> tensor<10x20xf32>
    return %1 : tensor<10x20xf32>
  }
}
)#"));
...
module {
  func @relu(%arg0: tensor<10x20xf32> {tile.name = "I"}) -> tensor<10x20xf32> {
    %cst = "eltwise.sconst"() {value = 0.000000e+00 : f64} : () -> !f32
    %0 = "eltwise.cmp_lt"(%arg0, %cst) : (tensor<10x20xf32>, !f32) -> tensor<10x20x!eltwise.u1>
    %1 = "eltwise.select"(%0, %cst, %arg0) : (tensor<10x20x!eltwise.u1>, !f32, tensor<10x20xf32>) -> tensor<10x20xf32>
    return %1 : tensor<10x20xf32>
  }
}
)#"));
...
module {
  func @variance(%arg0: tensor<10x20xf32> {tile.name = "A"}) -> !f32 {
    ...
    %1 = "eltwise.div"(%0, %c200) : (tensor<1x1xf32>, !i32) -> tensor<1x1xf32>
