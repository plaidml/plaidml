local exports = [
  ...
  "tile_expr_contraction_set_no_defract",
  "tile_expr_contraction_set_use_default",
  "tile_expr_evaluate_shape",
  "tile_expr_float",
  "tile_expr_float_get_value",
  "tile_expr_free",
  "tile_expr_int",
  "tile_expr_int_get_value",
  "tile_expr_param",
  "tile_expr_repr",
  "tile_expr_tensor_spec",
  "tile_poly_expr_add_constraint",
  "tile_poly_expr_free",
  "tile_poly_expr_index",
  "tile_poly_expr_literal",
  "tile_poly_expr_op",
  "tile_poly_expr_repr",
  "tile_program_evaluate",
  "tile_program_free",
  "tile_program_repr",
  "tile_program_runinfo",
  "tile_shape_add_dimension",
  "tile_shape_alloc",
  "tile_shape_free",
  "tile_shape_get_byte_size",
  "tile_shape_get_dimension_size",
  "tile_shape_get_dimension_stride",
  "tile_shape_get_ptr",
  "tile_shape_get_rank",
  "tile_shape_get_type",
  "tile_shape_repr",
