...
pushd $(@D)/buildov;
cmake -GNinja ../../../../../../external/openvino -DENABLE_CLDNN=OFF -DENABLE_VPU=OFF -DENABLE_MYRIAD=OFF -DENABLE_MKL_DNN=OFF -DENABLE_GNA=OFF -DENABLE_PLAIDML=ON -DENABLE_SPEECH_DEMO=OFF -DPLAIDML_SO_PATH=./libplaidml.so
popd;
