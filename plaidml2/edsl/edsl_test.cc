...
module {
  func @mnist_mlp(%arg0: tensor<10x!eltwise.fp32>, %arg1: tensor<512x10x!eltwise.fp32>, %arg2: tensor<512x!eltwise.fp32>, %arg3: tensor<512x512x!eltwise.fp32>, %arg4: tensor<512x!eltwise.fp32>, %arg5: tensor<784x512x!eltwise.fp32>, %arg6: tensor<1x784x!eltwise.fp32>) -> tensor<1x10x!eltwise.fp32> {
    ...
    %c512 = "tile.affine_const"() {value = 512 : i64} : () -> !eltwise.i32
    %cst = "eltwise.sconst"() {value = 0.000000e+00 : f64} : () -> !fp32
    %c0 = "tile.affine_const"() {value = 0 : i64} : () -> !eltwise.i32
    %c1 = "tile.affine_const"() {value = 1 : i64} : () -> !eltwise.i32
    %0 = "tile.domain"(%arg6, %arg5) ( {
    ^bb0(%arg7: tensor<1x784x!eltwise.fp32>, %arg8: tensor<784x512x!eltwise.fp32>, %arg9: !eltwise.i32, %arg10: !eltwise.i32, %arg11: !eltwise.i32):	// no predecessors
      %15 = "tile.src_idx_map"(%arg7, %arg10, %arg9) : (tensor<1x784x!eltwise.fp32>, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %16 = "tile.src_idx_map"(%arg8, %arg9, %arg11) : (tensor<784x512x!eltwise.fp32>, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %17 = "tile.sink_idx_map"(%arg10, %arg11) : (!eltwise.i32, !eltwise.i32) -> !tile.imap
      %18 = "tile.size_map"(%c1, %c512) : (!eltwise.i32, !eltwise.i32) -> !tile.smap
      "tile.+(x*y)"(%18, %15, %16, %17) : (!tile.smap, !tile.imap, !tile.imap, !tile.imap) -> ()
    }) {idx_names = ["x0", "x1", "x2"]} : (tensor<1x784x!eltwise.fp32>, tensor<784x512x!eltwise.fp32>) -> tensor<1x512x!eltwise.fp32>
    ...
    %4 = "tile.domain"(%3, %arg3) ( {
    ^bb0(%arg7: tensor<1x512x!eltwise.fp32>, %arg8: tensor<512x512x!eltwise.fp32>, %arg9: !eltwise.i32, %arg10: !eltwise.i32, %arg11: !eltwise.i32):	// no predecessors
      %15 = "tile.src_idx_map"(%arg7, %arg10, %arg9) : (tensor<1x512x!eltwise.fp32>, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %16 = "tile.src_idx_map"(%arg8, %arg9, %arg11) : (tensor<512x512x!eltwise.fp32>, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %17 = "tile.sink_idx_map"(%arg10, %arg11) : (!eltwise.i32, !eltwise.i32) -> !tile.imap
      %18 = "tile.size_map"(%c1, %c512) : (!eltwise.i32, !eltwise.i32) -> !tile.smap
      "tile.+(x*y)"(%18, %15, %16, %17) : (!tile.smap, !tile.imap, !tile.imap, !tile.imap) -> ()
    }) {idx_names = ["x0", "x1", "x2"]} : (tensor<1x512x!eltwise.fp32>, tensor<512x512x!eltwise.fp32>) -> tensor<1x512x!eltwise.fp32>
    ...
    %8 = "tile.domain"(%7, %arg1) ( {
    ^bb0(%arg7: tensor<1x512x!eltwise.fp32>, %arg8: tensor<512x10x!eltwise.fp32>, %arg9: !eltwise.i32, %arg10: !eltwise.i32, %arg11: !eltwise.i32):	// no predecessors
      %15 = "tile.src_idx_map"(%arg7, %arg10, %arg9) : (tensor<1x512x!eltwise.fp32>, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %16 = "tile.src_idx_map"(%arg8, %arg9, %arg11) : (tensor<512x10x!eltwise.fp32>, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %17 = "tile.sink_idx_map"(%arg10, %arg11) : (!eltwise.i32, !eltwise.i32) -> !tile.imap
      %18 = "tile.size_map"(%c1, %c10) : (!eltwise.i32, !eltwise.i32) -> !tile.smap
      "tile.+(x*y)"(%18, %15, %16, %17) : (!tile.smap, !tile.imap, !tile.imap, !tile.imap) -> ()
    }) {idx_names = ["x0", "x1", "x2"]} : (tensor<1x512x!eltwise.fp32>, tensor<512x10x!eltwise.fp32>) -> tensor<1x10x!eltwise.fp32>
    %9 = "eltwise.add"(%8, %arg0) {type = !eltwise.fp32} : (tensor<1x10x!eltwise.fp32>, tensor<10x!eltwise.fp32>) -> tensor<1x10x!eltwise.fp32>
    %10 = "tile.domain"(%9) ( {
    ^bb0(%arg7: tensor<1x10x!eltwise.fp32>, %arg8: !eltwise.i32, %arg9: !eltwise.i32):	// no predecessors
      %15 = "tile.src_idx_map"(%arg7, %arg9, %arg8) : (tensor<1x10x!eltwise.fp32>, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %16 = "tile.sink_idx_map"(%arg9, %c0) : (!eltwise.i32, !eltwise.i32) -> !tile.imap
      %17 = "tile.size_map"(%c1, %c1) : (!eltwise.i32, !eltwise.i32) -> !tile.smap
      "tile.>(x)"(%17, %15, %16) : (!tile.smap, !tile.imap, !tile.imap) -> ()
    }) {idx_names = ["x0", "x1"]} : (tensor<1x10x!eltwise.fp32>) -> tensor<1x1x!eltwise.fp32>
...
module {
  func @lars_momentum4d(%arg0: tensor<4x7x3x9x!eltwise.fp32>, %arg1: tensor<4x7x3x9x!eltwise.fp32>, %arg2: !fp32, %arg3: tensor<4x7x3x9x!eltwise.fp32>) -> (tensor<4x7x3x9x!eltwise.fp32>, tensor<4x7x3x9x!eltwise.fp32>) {
    ...
    %cst_0 = "eltwise.sconst"() {value = 9.765625E-4 : f64} : () -> !fp32
    %cst_1 = "eltwise.sconst"() {value = 1.250000e-01 : f64} : () -> !fp32
    ...
    %3 = "tile.domain"(%2) ( {
    ^bb0(%arg4: tensor<4x7x3x9x!eltwise.fp32>, %arg5: !eltwise.i32, %arg6: !eltwise.i32, %arg7: !eltwise.i32, %arg8: !eltwise.i32):	// no predecessors
      %17 = "tile.src_idx_map"(%arg4, %arg8, %arg7, %arg6, %arg5) : (tensor<4x7x3x9x!eltwise.fp32>, !eltwise.i32, !eltwise.i32, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %18 = "tile.sink_idx_map"() : () -> !tile.imap
      %19 = "tile.size_map"() : () -> !tile.smap
      "tile.+(x)"(%19, %17, %18) : (!tile.smap, !tile.imap, !tile.imap) -> ()
    }) {idx_names = ["x0", "x1", "x2", "x3"]} : (tensor<4x7x3x9x!eltwise.fp32>) -> !fp32
...
module {
  func @repeat_elts(%arg0: tensor<10x10x10x!eltwise.fp32>) -> tensor<10x30x10x!eltwise.fp32> {
    %c30 = "tile.affine_const"() {value = 30 : i64} : () -> !eltwise.i32
    %c10 = "tile.affine_const"() {value = 10 : i64} : () -> !eltwise.i32
    %c3 = "tile.affine_const"() {value = 3 : i64} : () -> !eltwise.i32
    %0 = "tile.domain"(%arg0) ( {
    ^bb0(%arg1: tensor<10x10x10x!eltwise.fp32>, %arg2: !eltwise.i32, %arg3: !eltwise.i32, %arg4: !eltwise.i32, %arg5: !eltwise.i32):	// no predecessors
      %1 = "tile.src_idx_map"(%arg1, %arg4, %arg3, %arg2) : (tensor<10x10x10x!eltwise.fp32>, !eltwise.i32, !eltwise.i32, !eltwise.i32) -> !tile.imap
      ...
      %4 = "tile.sink_idx_map"(%arg4, %3, %arg2) : (!eltwise.i32, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %5 = "tile.size_map"(%c10, %c30, %c10) : (!eltwise.i32, !eltwise.i32, !eltwise.i32) -> !tile.smap
      "tile.constraint"(%arg5, %c3) ( {
        "tile.=(x)"(%5, %1, %4) : (!tile.smap, !tile.imap, !tile.imap) -> ()
      }) : (!eltwise.i32, !eltwise.i32) -> ()
    }) {idx_names = ["x0", "x1", "x2", "x3"], no_reduce = true} : (tensor<10x10x10x!eltwise.fp32>) -> tensor<10x30x10x!eltwise.fp32>
...
module {
  func @use_default(%arg0: tensor<1x10x10x!eltwise.fp32>, %arg1: tensor<1x7x10x10x!eltwise.fp32>) -> tensor<1x7x10x10x!eltwise.fp32> {
    ...
    %c1 = "tile.affine_const"() {value = 1 : i64} : () -> !eltwise.i32
    %0 = "tile.domain"(%arg0) ( {
    ^bb0(%arg2: tensor<1x10x10x!eltwise.fp32>, %arg3: !eltwise.i32, %arg4: !eltwise.i32, %arg5: !eltwise.i32):	// no predecessors
      %1 = "tile.src_idx_map"(%arg2, %arg5, %arg4, %arg3) : (tensor<1x10x10x!eltwise.fp32>, !eltwise.i32, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %2 = "tile.sink_idx_map"(%arg5, %c3, %arg4, %arg3) : (!eltwise.i32, !eltwise.i32, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %3 = "tile.size_map"(%c1, %c7, %c10, %c10) : (!eltwise.i32, !eltwise.i32, !eltwise.i32, !eltwise.i32) -> !tile.smap
      "tile.=(x)"(%3, %1, %2, %arg1) : (!tile.smap, !tile.imap, !tile.imap, tensor<1x7x10x10x!eltwise.fp32>) -> ()
    }) {idx_names = ["x0", "x1", "x2"]} : (tensor<1x10x10x!eltwise.fp32>) -> tensor<1x7x10x10x!eltwise.fp32>
...
module {
  func @arg_max(%arg0: tensor<1x10x10x!eltwise.fp32>) -> tensor<1x10x!eltwise.u32> {
    ...
    %0 = "tile.domain"(%c1_0) ( {
    ^bb0(%arg1: !i32, %arg2: !eltwise.i32):	// no predecessors
      %5 = "tile.src_idx_map"(%arg1) : (!i32) -> !tile.imap
      %6 = "tile.sink_idx_map"(%arg2) : (!eltwise.i32) -> !tile.imap
      %7 = "tile.size_map"(%c10) : (!eltwise.i32) -> !tile.smap
      "tile.=(x)"(%7, %5, %6) : (!tile.smap, !tile.imap, !tile.imap) -> ()
    }) {idx_names = ["x0"]} : (!i32) -> tensor<10x!eltwise.i32>
    %1 = "tile.index"(%0) {dim = 0 : i64} : (tensor<10x!eltwise.i32>) -> tensor<10x!eltwise.i32>
    %2 = "tile.domain"(%arg0) ( {
    ^bb0(%arg1: tensor<1x10x10x!eltwise.fp32>, %arg2: !eltwise.i32, %arg3: !eltwise.i32, %arg4: !eltwise.i32):	// no predecessors
      %5 = "tile.src_idx_map"(%arg1, %arg4, %arg3, %arg2) : (tensor<1x10x10x!eltwise.fp32>, !eltwise.i32, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %6 = "tile.sink_idx_map"(%arg4, %arg2) : (!eltwise.i32, !eltwise.i32) -> !tile.imap
      %7 = "tile.size_map"(%c1, %c10) : (!eltwise.i32, !eltwise.i32) -> !tile.smap
      "tile.>(x)"(%7, %5, %6) : (!tile.smap, !tile.imap, !tile.imap) -> ()
    }) {idx_names = ["x0", "x1", "x2"]} : (tensor<1x10x10x!eltwise.fp32>) -> tensor<1x10x!eltwise.fp32>
    %3 = "tile.domain"(%arg0, %2, %1) ( {
    ^bb0(%arg1: tensor<1x10x10x!eltwise.fp32>, %arg2: tensor<?x?x!eltwise.fp32>, %arg3: tensor<?x!eltwise.i32>, %arg4: !eltwise.i32, %arg5: !eltwise.i32, %arg6: !eltwise.i32):	// no predecessors
      %5 = "tile.src_idx_map"(%arg1, %arg6, %arg5, %arg4) : (tensor<1x10x10x!eltwise.fp32>, !eltwise.i32, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %6 = "tile.src_idx_map"(%arg2, %arg6, %arg4) : (tensor<?x?x!eltwise.fp32>, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %7 = "tile.src_idx_map"(%arg3, %arg5) : (tensor<?x!eltwise.i32>, !eltwise.i32) -> !tile.imap
      %8 = "tile.sink_idx_map"(%arg6, %arg4) : (!eltwise.i32, !eltwise.i32) -> !tile.imap
      %9 = "tile.size_map"(%c1, %c10) : (!eltwise.i32, !eltwise.i32) -> !tile.smap
      "tile.>(x==y?z)"(%9, %5, %6, %7, %8) : (!tile.smap, !tile.imap, !tile.imap, !tile.imap, !tile.imap) -> ()
    }) {idx_names = ["x0", "x1", "x2"]} : (tensor<1x10x10x!eltwise.fp32>, tensor<1x10x!eltwise.fp32>, tensor<10x!eltwise.i32>) -> tensor<1x10x!eltwise.i32>
...
module {
  func @global_min(%arg0: tensor<10x10x10x!eltwise.fp32> {tile.name = "I"}) -> !fp32 {
    ...
    %1 = "tile.domain"(%0) ( {
    ^bb0(%arg1: tensor<10x10x10x!eltwise.fp32>, %arg2: !eltwise.i32, %arg3: !eltwise.i32, %arg4: !eltwise.i32):	// no predecessors
      %3 = "tile.src_idx_map"(%arg1, %arg4, %arg3, %arg2) : (tensor<10x10x10x!eltwise.fp32>, !eltwise.i32, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %4 = "tile.sink_idx_map"() : () -> !tile.imap
      %5 = "tile.size_map"() : () -> !tile.smap
      "tile.>(x)"(%5, %3, %4) : (!tile.smap, !tile.imap, !tile.imap) -> ()
    }) {idx_names = ["x0", "x1", "x2"]} : (tensor<10x10x10x!eltwise.fp32>) -> !fp32
...
module {
  func @cumsum(%arg0: tensor<10x!eltwise.fp32> {tile.name = "I"}) -> tensor<10x!eltwise.fp32> {
    %c10 = "tile.affine_const"() {value = 10 : i64} : () -> !eltwise.i32
    %0 = "tile.domain"(%arg0) ( {
    ^bb0(%arg1: tensor<10x!eltwise.fp32>, %arg2: !eltwise.i32, %arg3: !eltwise.i32):	// no predecessors
      %1 = "tile.src_idx_map"(%arg1, %arg2) : (tensor<10x!eltwise.fp32>, !eltwise.i32) -> !tile.imap
      %2 = "tile.sink_idx_map"(%arg3) : (!eltwise.i32) -> !tile.imap
      %3 = "tile.size_map"(%c10) : (!eltwise.i32) -> !tile.smap
      %4 = "tile.affine_sub"(%arg3, %arg2) : (!eltwise.i32, !eltwise.i32) -> !eltwise.i32
      "tile.constraint"(%4, %c10) ( {
        "tile.+(x)"(%3, %1, %2) : (!tile.smap, !tile.imap, !tile.imap) -> ()
      }) : (!eltwise.i32, !eltwise.i32) -> ()
    }) {idx_names = ["x0", "x1"]} : (tensor<10x!eltwise.fp32>) -> tensor<10x!eltwise.fp32>
...
module {
  func @complex_conv_2d(%arg0: tensor<1x224x224x3x3x!eltwise.fp32>, %arg1: tensor<3x3x3x3x32x!eltwise.fp32>) -> tensor<1x112x112x3x32x!eltwise.fp32> {
    ...
    %c3 = "tile.affine_const"() {value = 3 : i64} : () -> !eltwise.i32
    %c1 = "tile.affine_const"() {value = 1 : i64} : () -> !eltwise.i32
    %0 = "tile.domain"(%arg0, %arg1) ( {
    ^bb0(%arg2: tensor<1x224x224x3x3x!eltwise.fp32>, %arg3: tensor<3x3x3x3x32x!eltwise.fp32>, %arg4: !eltwise.i32, %arg5: !eltwise.i32, %arg6: !eltwise.i32, %arg7: !eltwise.i32, %arg8: !eltwise.i32, %arg9: !eltwise.i32, %arg10: !eltwise.i32, %arg11: !eltwise.i32):	// no predecessors
      %1 = "tile.affine_mul"(%arg6, %c3) : (!eltwise.i32, !eltwise.i32) -> !eltwise.i32
      %2 = "tile.affine_mul"(%arg7, %c2) : (!eltwise.i32, !eltwise.i32) -> !eltwise.i32
      %3 = "tile.affine_add"(%2, %1) : (!eltwise.i32, !eltwise.i32) -> !eltwise.i32
      %4 = "tile.affine_sub"(%3, %c2) : (!eltwise.i32, !eltwise.i32) -> !eltwise.i32
      %5 = "tile.affine_mul"(%arg8, %c3) : (!eltwise.i32, !eltwise.i32) -> !eltwise.i32
      %6 = "tile.affine_mul"(%arg9, %c2) : (!eltwise.i32, !eltwise.i32) -> !eltwise.i32
      %7 = "tile.affine_add"(%6, %5) : (!eltwise.i32, !eltwise.i32) -> !eltwise.i32
      %8 = "tile.affine_sub"(%7, %c2) : (!eltwise.i32, !eltwise.i32) -> !eltwise.i32
      %9 = "tile.src_idx_map"(%arg2, %arg10, %8, %4, %arg5, %arg4) : (tensor<1x224x224x3x3x!eltwise.fp32>, !eltwise.i32, !eltwise.i32, !eltwise.i32, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %10 = "tile.src_idx_map"(%arg3, %arg8, %arg6, %arg5, %arg4, %arg11) : (tensor<3x3x3x3x32x!eltwise.fp32>, !eltwise.i32, !eltwise.i32, !eltwise.i32, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %11 = "tile.sink_idx_map"(%arg10, %arg9, %arg7, %arg5, %arg11) : (!eltwise.i32, !eltwise.i32, !eltwise.i32, !eltwise.i32, !eltwise.i32) -> !tile.imap
      %12 = "tile.size_map"(%c1, %c112, %c112, %c3, %c32) : (!eltwise.i32, !eltwise.i32, !eltwise.i32, !eltwise.i32, !eltwise.i32) -> !tile.smap
      "tile.+(x*y)"(%12, %9, %10, %11) : (!tile.smap, !tile.imap, !tile.imap, !tile.imap) -> ()
    }) {idx_names = ["x0", "x1", "x2", "x3", "x4", "x5", "x6", "x7"]} : (tensor<1x224x224x3x3x!eltwise.fp32>, tensor<3x3x3x3x32x!eltwise.fp32>) -> tensor<1x112x112x3x32x!eltwise.fp32>
