...
def vectorize_stories(data, word_idx, story_maxlen, query_maxlen):
    ...
    for story, query, answer in data:
        ...
        xqs.append(xq)
        ys.append(y)
    return pad_sequences(xs, maxlen=story_maxlen), pad_sequences(xqs,
                                                                 maxlen=query_maxlen), np.array(ys)
...
print('RNN / Embed / Sent / Query = {}, {}, {}, {}'.format(RNN, EMBED_HIDDEN_SIZE,
                                                           SENT_HIDDEN_SIZE, QUERY_HIDDEN_SIZE))
