...
def vectorize_stories(data, word_idx, story_maxlen, query_maxlen):
    ...
    for story, query, answer in data:
        ...
        Xq.append(xq)
        Y.append(y)
    return (pad_sequences(X, maxlen=story_maxlen), pad_sequences(Xq,
                                                                 maxlen=query_maxlen), np.array(Y))
...
inputs_train, queries_train, answers_train = vectorize_stories(train_stories, word_idx,
