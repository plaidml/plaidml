...
from example_correctness_test_utils import TrainingHistoryList, StopwatchManager
...
output.contents = np.array(history.acc + history.loss + history.val_loss + history.val_acc)
