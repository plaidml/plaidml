...
if __name__ == '__main__':
    ...
    for epoch in range(1, epochs + 1):
        ...
        real_images = x_train[(epoch - 1) * num_rows * num_classes:epoch * num_rows *
                              num_classes][indices]
    ...
    output.contents = None
    for i in test_history['generator']:
        if output.contents is None:
            output.contents = i
        else:
            output.contents = np.concatenate((output.contents, i), axis=0)
    for i in test_history['discriminator']:
        output.contents = np.concatenate((output.contents, i), axis=0)

    # Don't save the history to *.pkl
