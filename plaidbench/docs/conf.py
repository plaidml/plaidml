...
html_context = {
    'css_files': [
        '_static/theme_overrides.css',  # fix the wide table issue
    ],
}
...
htmlhelp_basename = 'plaidbenchdoc'
...
man_pages = [(master_doc, 'plaidbench', u'plaidbench Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'plaidbench', u'plaidbench Documentation', author, 'plaidbench',
