...
void Emit::Visit(const sem::CallExpr& n) {
  ...
  switch (n.function) {
    ...
    case sem::CallExpr::Function::TANH:
      ...
      devectorize = true;
      break;
    case sem::CallExpr::Function::SUB_GROUP_BROADCAST:
      throw Error("No definition for sub_group_broadcast on this platform");
  }
...
void Emit::Visit(const sem::SpecialStmt& n) { throw std::runtime_error("Invalid Special Statement in CPU codegen"); }
