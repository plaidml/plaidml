...
std::pair<std::string, std::function<Program()>> MakeEntry(const std::string& name,  //
                                                           std::function<Program(const std::string& name)> fn) {
