  ...
  static std::map<std::string, lang::RunInfo> tests = {
      ...
      },
      {
          ...
          lib::LoadDilatedConv2d("dilated_conv2d",                              //
                                 ...
                                 SimpleShape(DataType::INT8, {3, 3, 64, 64}),   //
      ...
      },
      {
          ...
          lib::LoadConv2d("layer_test1",                                 //
                          SimpleShape(DataType::INT8, {1, 56, 56, 64}),  //
                          SimpleShape(DataType::INT8, {1, 1, 64, 64}),   //
                          SimpleShape(DataType::INT8, {1, 56, 56, 64}))  //
      },
      {
          "$layer_test2",
      ...
      },
      {
          ...
          lib::LoadConv2d("layer_test5",                                   //
                          ...
                          SimpleShape(DataType::INT8, {1, 1, 2048, 512}),  //
      ...
      },
      {
          ...
          lib::LoadConv2d3Deep("layer_test6",                                 //
                               ...
                               SimpleShape(DataType::INT8, {3, 3, 64, 64}),   // K1
                               SimpleShape(DataType::INT8, {3, 3, 64, 64}),   // K2
                               SimpleShape(DataType::INT8, {3, 3, 64, 64}),   // K2
      ...
      },
      {
          ...
          lib::LoadConv2d3Deep("layer_test7",                                     //
                               ...
                               SimpleShape(DataType::INT8, {3, 3, 32, 64}),       // K1
                               SimpleShape(DataType::INT8, {3, 3, 64, 64}),       // K2
                               SimpleShape(DataType::INT8, {3, 3, 64, 64}),       // K2
      ...
      },
      {
          ...
          lib::LoadConv2dBnRelu("layer_test8",                                 //
                                ...
                                SimpleShape(DataType::INT8, {3, 3, 63, 63}),   //
