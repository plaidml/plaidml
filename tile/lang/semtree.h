...
struct CondExpr : public Expression {
  ...
  ExprPtr fcase;
  Type type;
  CondExpr(ExprPtr c, ExprPtr t, ExprPtr f) : cond(c), tcase(t), fcase(f), type({Type::VALUE, DataType::INT32, 1, 0}) {}
...
struct SelectExpr : public Expression {
  ...
  ExprPtr fcase;
  Type type;
  SelectExpr(ExprPtr c, ExprPtr t, ExprPtr f) : cond(c), tcase(t), fcase(f), type({Type::VALUE, DataType::INT32, 1, 0}) {}
