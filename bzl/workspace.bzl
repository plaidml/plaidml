...
def plaidml_workspace():
    ...
    http_archive(
        name = "zlib",
        sha256 = "8043b2cec71a4f9108280bb589399b3e81ed3c467e64ee0ed094687a52edfd1c",
        urls = [
            "https://mirror.bazel.build/github.com/plaidml/depot/raw/master/zlib-1.2.8.tar.gz",
            "https://github.com/plaidml/depot/raw/master/zlib-1.2.8.tar.gz",
        ],
