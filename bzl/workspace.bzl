...
def plaidml_workspace():
    ...
    native.new_http_archive(
        ...
        build_file=str(Label("//vendor:boost.BUILD")),
    ...
    native.new_git_repository(
        ...
        tag="v9.95.0",
        build_file=str(Label("//vendor:easylogging.BUILD")),
    )
    ...
    native.new_http_archive(
        ...
        build_file=str(Label("//vendor:gmock.BUILD")),
    )
    ...
    native.new_http_archive(
        ...
        build_file=str(Label("//vendor:half.BUILD")),
    )
    ...
    native.new_git_repository(
        ...
        build_file=str(Label("//vendor:jsoncpp.BUILD")),
    )
    ...
    native.new_git_repository(
        ...
        build_file=str(Label("//vendor:minizip.BUILD")),
    )
    ...
    native.new_git_repository(
        ...
        build_file=str(Label("//vendor:opencl_headers.BUILD"))
    )
    ...
    native.new_git_repository(
        ...
        build_file=str(Label("//vendor:opencl_icd_loader.BUILD"))
    )
    ...
    native.new_http_archive(
        ...
        build_file=str(Label("//vendor:zlib.BUILD")),
    )
    ...
    native.new_http_archive(
        ...
        build_file=str(Label("//vendor:llvm.BUILD")),
    ...
    native.new_git_repository(
        ...
        build_file=str(Label("//vendor:mtlpp.BUILD"))
    )
...
def configure_protobuf():
    native.new_http_archive(
        ...
        build_file=str(Label("//vendor:protobuf.BUILD"))
    )
    ...
    native.new_http_archive(
        ...
        build_file=str(Label("//vendor:six.BUILD")),
